...
private fun MainContent(
    ...
    Column(
        ...
        Text(
            text = "Сохраните резерную копию, чтобы восстановить информацию о машинах при смене телефона или " +
                    "очистке данных у приложения (восстанавливать данные не нужно, если вы не меняли телефон" +
                    " и не проводили очистку данных, иначе могут удалиться текущие данные)",
            fontSize = 14.sp,
