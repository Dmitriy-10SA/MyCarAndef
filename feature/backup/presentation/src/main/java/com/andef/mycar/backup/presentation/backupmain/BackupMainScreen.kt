...
private fun MainContent(
    ...
    Column(
        ...
        Text(
            text = "Сохраните резерную копию, чтобы восстановить информацию о машинах при смене или " +
                    "очистке устройства (восстанавливать данные не нужно, если вы не меняли телефон" +
                    " или не проводили очистку, иначе могут удалиться текущие данные)",
            fontSize = 14.sp,
